                ...
                Center(
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 10),
                      Text(authC.loggedUser!.username.toString(), style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20)),
                      Text(authC.client.auth.currentUser!.email.toString(), style: TextStyle(color: Colors.white70)),
                    ],
                  ),
                ),
